...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            sensor_gains = [1 1.5 2 1.5 1];%[0 0 0 0 0];
            u_i = (ir_distances_wf - [x;y]*ones(1,n_sensors))*diag(sensor_gains); %zeros(2,5); you can use sensor gains instead of ones(1,nsensors)
            
            %for i=1:numel(ir_distances_wf)
            %     fprintf('IR %d: %0.3fm\n', i, ir_distances_wf(i));
            %end
            ...
            theta_ao = atan2(u_ao(2),u_ao(1)); %0;
            e_k = theta_ao - theta; %0
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_wf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            for i=1:n_sensors
                ...
                ir_distances_rf(:,i) = R * [ir_distances(i);0;1]; %zeros(3,1);
            end
            ...
            ir_distances_wf = R*ir_distances_rf; %zeros(3,5);
